        ...
        child: Column(
          ...
          children: [
            CustomTextFormField(
              ...
              validator: (value) => value.isEmpty ? 'Debe ingresar un título':null
            ),
            SizedBox(height: 15.0),
            CustomTextFormField(
              key: _summaryKey,
              hint: "Descripción",
              validator: (value) => value.isEmpty ? 'Debe ingresar una descripción':null
            ),
            SizedBox(height: 15.0),
            CustomTextFormField(
              key: _placeKey,
              hint: "Lugar",
              validator: (value) => value.isEmpty ? 'Debe ingresar un lugar':null
            ),
            SizedBox(height: 15.0),
            DateFormField(
              key: _dateKey,
